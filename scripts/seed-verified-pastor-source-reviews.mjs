...
export function reviewUpdateAlreadyApplied(task,update){return ["confirmed_role_title","confirmed_role_status","decision","official_sources","reviewed_at","note"].every((key)=>JSON.stringify(task[key])===JSON.stringify(update[key]));}
