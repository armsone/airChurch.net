...
export const isSupportedOfficialContentType=(contentType)=>/(?:text\/html|application\/xhtml\+xml|text\/plain|application\/(?:[\w.+-]+\+)?json)/i.test(contentType??"");
...
export async function collectPastorHistory(manifest, {
  ...
  async function fetchSource(source) {
    ...
    if (!isSupportedOfficialContentType(contentType)) throw new Error("unsupported_content_type");
