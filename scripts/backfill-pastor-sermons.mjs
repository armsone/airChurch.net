...
let checked=0;
do {
  const response=await fetch(`${baseUrl}/api/sermons/sync?scope=photo_pastors&start=${start}&limit=20`,{method:"POST",headers:{authorization:`Bearer ${maintenanceToken}`}});
