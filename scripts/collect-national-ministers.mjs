...
const NAME_DENY = new Set(["교회소개", "예배안내", "섬기는", "사람들", "목회자", "교역자", "부교역자", "전도사", "담임목사", "위임목사", "원로목사", "은퇴목사", "교육목사", "협동목사", "오시는길", "대한예수", "예수교장", "기독교대한", "하나님의", "말씀으로", "복음으로", "사랑으로", "성령으로", "하나님을", "예수님을", "교회학교", "교육부서", "청년부를", "공동체", "이용약관", "주보", "서울"]);
