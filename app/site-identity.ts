export const siteIdentities = {
  "airchurch.net": { domain: "airchurch.net", name: "에어처치", wordmark: "airchurch", headline: "말씀을 발견하고", tagline: "교회와 이어지는 곳" },
  "goodshare.net": { domain: "goodshare.net", name: "선한영향력", wordmark: "선한영향력", headline: "선한영향력", tagline: "작은 나눔으로 함께하는 곳" },
  "linechurch.net": { domain: "linechurch.net", name: "라인처치", wordmark: "라인처치", headline: "라인처치", tagline: "말씀으로 사람과 교회를 잇는 곳" },
} as const;
