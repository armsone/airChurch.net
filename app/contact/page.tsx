...
export default function ContactPage() {
  return <InfoShell kicker="CONTACT" title="잘못된 정보는 고치고, 권리자의 요청은 먼저 살핍니다" intro="교회 정보 수정, 저작권·비공개, 개인정보 요청처럼 운영 판단이 필요한 내용만 접수합니다. 일반 상담과 기도 응답은 제공하지 않습니다.">
    <section><h2>airChurch 공식 채널</h2><ul><li>운영 이메일 · <a href="mailto:airchurchnet@gmail.com">airchurchnet@gmail.com</a></li><li>공식 YouTube · <a href="https://www.youtube.com/@airChurchnet" target="_blank" rel="noopener noreferrer">youtube.com/@airChurchnet ↗</a></li><li>공식 Instagram · <a href="https://www.instagram.com/airchurchnet/" target="_blank" rel="noopener noreferrer">instagram.com/airchurchnet ↗</a></li></ul></section>
