...
const panelThemes:Record<string,{icon:string;tone:string}>={"말씀":{icon:"📖",tone:"word"},"찬양":{icon:"🎵",tone:"praise"},"뉴스":{icon:"📰",tone:"news"},"교회":{icon:"⛪",tone:"church"},"목회자":{icon:"👤",tone:"pastor"},"행사":{icon:"📅",tone:"event"},"선한 영향력":{icon:"💬",tone:"community"}};
