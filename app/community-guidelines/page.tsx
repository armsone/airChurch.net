...
export default function CommunityGuidelinesPage() {
  return <InfoShell kicker="COMMUNITY SAFETY" title="자유롭게 나누되, 공개 기준은 분명하게" intro="익명 글은 먼저 접수되고 운영자가 공개 또는 비공개만 판단합니다. airChurch는 논쟁을 지휘하거나 모든 글에 답변하지 않습니다.">
    ...
    <section><h2>응원의 글</h2><p>교회와 목회자 페이지의 응원글은 감사와 격려를 나누는 공개 공간입니다. 같은 브라우저에서는 30분에 한 번만 작성할 수 있으며, 개인정보·비방·민원·광고가 포함된 글은 운영자가 보류하거나 삭제할 수 있습니다. 문제 제보와 정보 수정은 공개 글 대신 <a href="/contact">운영 문의</a>를 이용해 주세요.</p></section>
