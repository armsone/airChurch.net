  ...
  return (
    <main id="top" className="integrated-portal">
      ...
      <section className="hero" id="primary-content" tabIndex={-1}>
        <div className="hero-welcome"><h1>{identity.headline} <span>{identity.tagline}</span></h1><img className="welcome-art" src="/images/welcome-olive-dove.png" width={1536} height={1024} alt="" aria-hidden="true" /></div>
      ...
      <div className="page-jumps" aria-label="페이지 빠른 이동"><a href="#top" aria-label="맨 위로 이동" title="맨 위로">↑</a><a className="jump-logo" href="#portal-today-title" aria-label="투데이로 이동" title="투데이" /><a className="jump-praise" href="#praises" aria-label="CCM과 찬양으로 이동" title="CCM 듣기">♫</a><a href="#page-bottom" aria-label="맨 아래로 이동" title="맨 아래로">↓</a></div>
    </main>
  );
}
