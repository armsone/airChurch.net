...
export default function AdminSearchCard({admin,href,label,className,children,controls,linksOnly=false}:{admin:boolean;href:string;label:string;className:string;children:ReactNode;controls?:ReactNode;linksOnly?:boolean}){
