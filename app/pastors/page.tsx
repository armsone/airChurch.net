...
export default async function PastorsPage({searchParams}:{searchParams:Promise<{q?:string}>}){
  ...
  const rows=await db.prepare(`
    ...
    SELECT people.*,COUNT(*) OVER() AS total_count FROM people ORDER BY name,church_name LIMIT 240
