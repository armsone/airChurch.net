...
export default function PrivacyPage() {
  return <InfoShell kicker="PRIVACY" title="필요한 정보만, 공개 자료는 공개 범위에서만" intro="airChurch는 교회 공개 자료를 정리하며, 서비스 운영과 남용 방지에 필요한 최소한의 정보만 처리합니다. 시행일: 2026년 8월 31일">
    ...
    <section><h2>브라우저에만 저장되는 정보</h2><p>‘오늘의 5분’ 진행 상태, 사용자가 적은 오늘의 한 줄, 찜한 말씀·찬양·교회는 로그인 없이 현재 브라우저의 로컬 저장소에만 보관합니다. airChurch 서버로 전송하지 않으며, 브라우저의 사이트 데이터 삭제 기능으로 언제든 지울 수 있습니다.</p></section>
    ...
    <section><h2>보관과 삭제</h2><p>익명 방문 통계는 90일, 마지막 활동 기록은 30일이 지나면 자동 삭제합니다. 반복 제출을 막기 위한 접속환경 해시와 횟수는 접수 본문과 별도 테이블에 보관하고 최대 2일 안에 자동 삭제합니다. 브라우저의 추적 금지 설정이 켜져 있으면 방문 기록을 보내지 않습니다. 그 밖의 정보는 접수 내용 검토와 공개 유지에 필요한 기간에만 보관하며 목적이 끝났거나 삭제 요청이 확인되면 삭제합니다. 법령상 보관 의무가 있는 경우에는 그 기간 동안 분리해 보관합니다.</p></section>
