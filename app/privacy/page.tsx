...
export default function PrivacyPage() {
  return <InfoShell kicker="PRIVACY" title="필요한 정보만, 공개 자료는 공개 범위에서만" intro="airChurch는 교회 공개 자료를 정리하며, 서비스 운영과 남용 방지에 필요한 최소한의 정보만 처리합니다. 시행일: 2026년 8월 31일">
    ...
    <section><h2>보관과 삭제</h2><p>익명 방문 통계는 90일, 마지막 활동 기록은 30일이 지나면 자동 삭제합니다. 브라우저의 추적 금지 설정이 켜져 있으면 방문 기록을 보내지 않습니다. 그 밖의 정보는 접수 내용 검토, 공개 유지, 남용 방지 등 필요한 기간에만 보관하며 목적이 끝났거나 삭제 요청이 확인되면 삭제합니다. 법령상 보관 의무가 있는 경우에는 그 기간 동안 분리해 보관합니다.</p></section>
