...
export default async function EventPage({params}:{params:Promise<{id:string}>}){
  ...
  return <main className="church-detail-shell events-shell"><header className="church-detail-header"><a className="brand" href="/">airchurch</a><a href="/events">전체 일정 →</a></header><article className="events-page event-detail"><span className="section-kicker">{item.category}</span><h1>{item.title}</h1>
