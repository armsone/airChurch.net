...
const menuItems = [["말씀", "/#sermons"], ["찬양", "/#praises"], ["이벤트", "/our-events"], ["교회", "/#church-directory"], ["목회자", "/#pastor-directory"], ["교계행사", "/#events"], ["교계소식", "/#church-news"], ["선한 영향력", "/#community"], ["소개", "/#vision"]] as const;
