...
const menuItems = [["말씀", "/#sermons"], ["찬양", "/#praises"], ["찬양대회", "/praise-contest"], ["교회", "/#church-directory"], ["목회자", "/#pastor-directory"], ["행사", "/#events"], ["교계소식", "/#church-news"], ["공동체", "/#community"], ["착한나눔", "/#goodshare"], ["소개", "/#vision"]] as const;
