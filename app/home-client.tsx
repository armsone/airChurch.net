...
const menuItems = [["말씀","#sermons"],["교회 찾기","#church-directory"],["목회자","/pastors"],["주제 탐색","#topic-discovery"],["나의 모음","/saved"],["공동체","#community"],["착한나눔","#goodshare"],["소개","#vision"]] as const;
