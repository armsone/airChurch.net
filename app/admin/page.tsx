...
import { database, ensureAnalyticsTables, ensureChurchRecommendationTables, ensureCommunityTables, ensureSermonTables } from "../api/_shared";
...
export default async function AdminPage() {
  ...
  const db = database();
  await Promise.all([ensureAnalyticsTables(db), ensureCommunityTables(db), ensureSermonTables(db), ensureChurchRecommendationTables(db)]);
