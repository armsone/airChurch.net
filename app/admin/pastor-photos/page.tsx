...
export default async function PastorPhotoReviewPage(){
  ...
  return <main className="admin-shell admin-subpage">
    <div className="admin-header page-utility-bar"><div className="admin-utility-nav"><span>관리자 · 사진 검토</span><a href="/admin">업무 대시보드</a><a href="/admin/pastor-identities">동일인 검토</a></div></div>
