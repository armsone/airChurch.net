...
export default function MediaBrowser({kind}:{kind:"sermon"|"short"}){
  ...
  return <>
    ...
    {kind==="sermon"&&query&&<p className="media-cts-link"><a href={`https://ac.cts.tv/search?skeyword=${encodeURIComponent(query)}`} target="_blank" rel="noopener noreferrer">‘{query}’ 관련 CTS 말씀·프로그램도 찾아보기 ↗</a></p>}
