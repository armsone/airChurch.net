...
export default function CopyrightPage() {
  return <InfoShell kicker="COPYRIGHT & SOURCES" title="도움이 되기 위해, 원작자의 권리부터 지킵니다" intro="airChurch는 콘텐츠를 소유한 것처럼 복제하지 않습니다. 공개된 공식 자료를 찾기 쉽게 정리하고 원래 제작자와 원문으로 연결합니다.">
    ...
    <section><h2>자료별 표시 범위</h2><dl><div><dt>뉴스</dt><dd>제목, 출처, 게시 시각과 내용을 대신하지 않는 짧은 소개만 표시하고 원문으로 연결합니다.</dd></div><div><dt>말씀·찬양·쇼츠</dt><dd>공식 YouTube가 제공하는 제목·썸네일·게시 정보와 원본 링크만 사용합니다.</dd></div><div><dt>교회 정보</dt><dd>공식 홈페이지·교단 명부·공식 채널에서 공개한 교회명, 담임목사, 지역, 교단과 연결 주소를 대조합니다.</dd></div><div><dt>성경 본문</dt><dd>저작권 허락이 확인되지 않은 번역문을 복제하거나 자동 번역해 게시하지 않고, 성경 서비스의 한국어 검색 페이지로 연결합니다.</dd></div></dl></section>
    <section><h2>권리자 요청</h2><p>교회·목회자·언론사·창작자가 정보 수정, 링크 변경, 임베드 중단 또는 비공개를 요청하면 권리 관계와 공식 연락처를 확인한 뒤 우선 노출을 보류하고 사실관계를 확인합니다. <a href="/contact">운영 문의</a>에서 <strong>저작권·비공개 요청</strong>을 선택해 주세요. 접수와 처리 자료는 개인정보처리방침의 기간에 따라 자동 삭제합니다.</p></section>
