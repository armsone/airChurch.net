...
import { database, ensurePrivateContactTables, ensureReviewerTables, ensureSermonTables } from "../api/_shared";
...
export default async function PastorPage() {
  ...
  const db=database();await Promise.all([ensureSermonTables(db),ensureReviewerTables(db),ensurePrivateContactTables(db)]);
