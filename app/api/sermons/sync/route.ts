...
type DatabaseSourceRow={name:string;pastor:string;region:string;denomination:string;homepage:string|null;channelId:string;priorityWeight:number;pastorNames?:string;primaryPastorNames?:string};
