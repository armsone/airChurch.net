...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: "https://airchurch.net/sermons", changeFrequency: "daily", priority: 0.7 },
    { url: "https://airchurch.net/shorts", changeFrequency: "daily", priority: 0.6 },
    { url: "https://airchurch.net/news", changeFrequency: "daily", priority: 0.6 },
    { url: "https://airchurch.net/faith-stories", changeFrequency: "daily", priority: 0.6 },
    { url: "https://airchurch.net/our-events", changeFrequency: "weekly", priority: 0.5 },
    { url: "https://airchurch.net/making", changeFrequency: "weekly", priority: 0.4 },
    { url: "https://airchurch.net/history", changeFrequency: "monthly", priority: 0.3 },
    { url: "https://airchurch.net/tech", changeFrequency: "monthly", priority: 0.3 },
    { url: "https://airchurch.net/theme", changeFrequency: "monthly", priority: 0.2 },
